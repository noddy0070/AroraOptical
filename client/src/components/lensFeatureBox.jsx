...
export const LensFeatureBox=({ img=placeholder, title, description,price,classNameLearnMore='',onclick = () => {console.log('pressed')} })=> {
    ...
    return (
        <div onClick={onclick} className=' cursor-pointer relative w-[16.1875vw] h-[19.8215vw] rounded-[1.1175vw] shadow-[0px_.25vw_.25vw_rgba(0,_0,_0,_0.25)] overflow-hidden ' onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
            <div className='  relative m-[.25vw] flex flex-col gap-[.25vw] transition-transform transform duration-700 ' style={{ transform: `scale(${hover ? 0.975 : 1})` }}>
                <img src={img} className='w-full h-[9.375vw] rounded-t-[1.0625vw] ' />
...
export const  LensTintBox=({ img=placeholder, title, description,price,classNameLearnMore='',onclick = () => {console.log('pressed')} })=> {
    const [hover, setHover] = useState(false);
    return (
        <div onClick={onclick} className='cursor-pointer relative  h-[19.8215vw] rounded-[1.1175vw] shadow-[0px_.25vw_.25vw_rgba(0,_0,_0,_0.25)] transform transition-all duration-700 overflow-hidden flex flex-row' 
        style={{width:hover?"36.625vw":"16.1875vw"}}    onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
            ...
            <div className='  relative m-[.25vw] flex flex-col gap-[.25vw] transition-transform transform duration-700 ' style={{ transform: `scale(${hover ? 0.95 : 1})` }}>
                ...
                <div  className='absolute bg-darkslategrey  flex flex-row justify-center items-center w-[16.27vw] h-[2.1875vw] rounded-b-[1.1175vw] overflow-hidden cursor-pointer  transition-all transform duration-500' style={{bottom: hover ?'0' :'-2.1875vw'}}>
                        <p className='text-smallText font-roboto text-white leading-[150%] text-clip'>SELECT</p>
                </div>
            </div>
                ...
                <div className='flex flex-col gap-[1.5vw] ml-[3.125vw] w-min'>
                    ...
                    <div className='flex flex-row gap-[1.5vw] overflow-hidden' >
                        <div className='min-w-[4vw]  overflow-hidden'>
                            <img src={greyTintImg} className='w-auto h-[2.875vw] '/>
                            <p className='text-smallText font-roboto text-center py-[.25vw]'>Grey</p>
                        </div>
                        <div className='min-w-[4vw] overflow-hidden'>
                            <img src={brownTintImg} className='w-auto h-[2.875vw] '/>
                            <p className='text-smallText font-roboto text-center py-[.25vw]'>Brow</p>
                        </div>
                        <div className='min-w-[4vw] overflow-hidden'>
                            <img src={greenTintImg} className='w-auto h-[2.875vw]'/>

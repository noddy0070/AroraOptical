...
export default function LensCoating({amount,form,setForm,handleFocus, subFocusedCoating, setSubFocusedCoating}) {
    return (
        <div id='lensCoatingMain' className='' >
            ...
            <div className='mx-auto py-[1.5vw] px-[1vw] flex flex-row gap-[1.5vw] w-min'>
                    <LensFeatureBox onclick={()=>{setForm({...form,lensCoating:"Clear-Vision"});handleFocus("lensThickness")}} title={"Clear Vision"} description={"Reduces reflections for sharper, clearer vision in any light."} price={"Free"} />
                    ...
                    <LensFeatureBox onclick={()=>{setForm({...form,lensCoating:"Photochromatic"});handleFocus("lensThickness")}} title={"Photochromatic"} description={"Adapts to light, darkening outdoors and staying clear indoors."} price={"Free"} />
            </div>

...
import { LensTintBox, PriceBreakdown } from '../../components/lensFeatureBox';

export default function LensTint({amount,form,setForm,handleFocus,setAmount,basePrice=0,setCoatingPrice}) {
    return (

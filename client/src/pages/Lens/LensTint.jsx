    ...
    return (
        <div id='lensTintMain' className='' >
            ...
            <div className='mx-auto py-[1.5vw] px-[1vw] flex flex-row gap-[1.5vw] w-min'>
                    <LensTintBox handleFocus={handleFocus} form={form} setForm={setForm} title={"Solid Tint"} description={"Uniform color throughout the lens for a bold, consistent look and UV protection."} price={1200} setAmount={setAmount} amount={amount} />
                    <LensTintBox handleFocus={handleFocus} form={form} setForm={setForm} title={"Gradient Tint"} description={"A stylish fade from dark to light, offering sun protection with a modern touch."} price={1300} setAmount={setAmount} amount={amount} />
            </div>

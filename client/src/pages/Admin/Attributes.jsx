...
export default function AttributesPage() {
    ...
    const deleteAttribute = async (attributeId) => {
      ...
      try {
        const response = await axios.delete(`${baseURL}/api/admin/delete-attributes/${attributeId}`, {
          withCredentials: true
    ...
    return (
        <div className="w-full px-[2.25vw] py-[2.25vw] flex flex-col gap-[5.5vw] font-roboto">
            <div className="shadow-adminShadow w-full py-[1.5vw] min-h-screen">
                ...
                <table className="w-full text-center px-[1.875vw]">
                <thead>
                  <tr>
                    <th className="text-regularText font-bold">Attribute Name</th>
                    <th className="text-regularText font-bold">Attribute Type</th>
                    <th className="text-regularText font-bold">Attribute Value Type</th>
                    <th className="text-regularText font-bold">Action</th>
                  </tr>
                </thead>
                <tbody>
                  {attributes.map((attribute, index) => (
                    <tr key={index}>
                      <td className="text-regularText font-roboto py-[0.5vw]">{attribute.name}</td>
                      <td className="text-regularText font-roboto py-[0.5vw]">{attribute.attributeType}</td>
                      <td className="text-regularText font-roboto py-[0.5vw]">{attribute.attributeValueType}</td>
                      <td className="py-[0.5vw]">
                        <div className="flex justify-center gap-[.625vw] items-center">

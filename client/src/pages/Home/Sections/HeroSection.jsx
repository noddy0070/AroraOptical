            ...
            <div className='absolute top-0 left-0 h-full w-full px-[4vw] py-[3vw] '>
                <div className='relative ' >
                    <div className='absolute w-[39.875vw] left-0'>
                        ...
                        <span className='font-roboto text-black overflow-hidden text-mediumText     '>Discover our curated collection of eyewear, blending the convenience 
                ...
                <div className='absolute bottom-0 pb-[3vw] w-full pr-[4vw] '>
                    <div className=' flex flex-row justify-center w-full'>
                        <div className='flex flex-col'>
                            <TitleButton  btnTitle={"Shop"} btnRadius={3.125} btnHeight={4.25}  btnWidth={16}/>
                            <span className='text-regularText pt-[.875vw] font-roboto  w-full text-center leading-[150%]'>Learn More</span>
